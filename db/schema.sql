...
ALTER TABLE IF EXISTS listing
  ...
  ADD COLUMN IF NOT EXISTS baths INT DEFAULT 0,
  ADD COLUMN IF NOT EXISTS sqft INT DEFAULT 0,
  ADD COLUMN IF NOT EXISTS description TEXT,
  ADD COLUMN IF NOT EXISTS image VARCHAR(500),
  ADD COLUMN IF NOT EXISTS status VARCHAR(50) DEFAULT 'active',
  ADD COLUMN IF NOT EXISTS created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
  ADD COLUMN IF NOT EXISTS updated_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
  ADD COLUMN IF NOT EXISTS created_by_user_id INT REFERENCES app_user(user_id) ON DELETE SET NULL;
